...
class ModelLoader:
    ...
    def load_embeddings(self):
        """
        Load and return a synchronous embedding model (FAISS).
        """
        try:
            log.info("Loading FAISS embedding model...")
            from langchain_community.embeddings import FakeEmbeddings
            # You can replace FakeEmbeddings with another synchronous embedding model if needed
